...
import edu.isel.pdm.beegeesapp.bgg.games.model.CategoriesMapper
import edu.isel.pdm.beegeesapp.bgg.games.model.GamesMapper
import edu.isel.pdm.beegeesapp.bgg.games.model.MechanicsMapper

class GetGamesRequest(
    url: String,
    success: Response.Listener<GamesMapper>,
    error: Response.ErrorListener
) : JsonRequest<GamesMapper>(Method.GET, url, "", success, error) {
